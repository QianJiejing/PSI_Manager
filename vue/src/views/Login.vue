<template>
  <div class="container">
    <div style="width: 400px; padding: 30px; background-color: white; border-radius: 5px;">
      <div style="text-align: center; font-size: 20px; margin-bottom: 20px; color: #333">欢迎进入慢慢选仓储管理系统</div>
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="role">
          <el-select style="width: 100%" placeholder="请选择角色" v-model="form.role">
